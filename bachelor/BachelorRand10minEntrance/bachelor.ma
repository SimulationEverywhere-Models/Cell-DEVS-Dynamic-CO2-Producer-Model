...
rule : { ~c := $conc; ~ty := $type; ~co := $counter; ~dir := $direction;} {$counter := $counter + 1; $direction := 60;} 1000 { ($type = -200 AND (-1, 0)~ty != -100) AND NOT($counter = 2 OR $counter = 5)}

rule : { ~c := $conc; ~ty := $type; ~co := $counter; ~dir := $direction;} {$counter := $counter + 1; $direction := 40;} 1000 { ($type = -200 AND (1,0)~ty != -100) AND NOT($counter = 2 OR $counter = 5)}

rule : { ~c := $conc; ~ty := $type; ~co := $counter; ~dir := $direction;} {$counter := $counter + 1; $direction := 20;} 1000 { ($type = -200 AND (0,-1)~ty != -100) AND NOT($counter = 2 OR $counter = 5)}

rule : { ~c := $conc; ~ty := $type; ~co := $counter; ~dir := $direction;} {$counter := $counter + 1; $direction := 80;} 1000 { ($type = -200 AND (0,1)~ty  != -100) AND NOT($counter = 2 OR $counter = 5)}
